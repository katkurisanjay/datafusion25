...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    // Receipt number is optional for offline payments; do not require it here
    return true;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dataToSubmit = {
        ...
        receiptNo: formData.paymentMethod === 'Offline' ? formData.receiptNo : '',
      };
          ...
          {formData.paymentMethod === 'Offline' && (
            <div className="glass-effect rounded-xl p-6 border-2 border-warning/30">
              ...
              <div className="mt-4">
                ...
                />
                <p className="text-text-muted text-xs mt-1">Enter the receipt number here. </p>
              </div>
            </div>
          )}
